...
%% covariates reported in the Supplemental Information of the Kung et al., 
%% manuscript
...
% to generate the results detailed in eTable 12 in the Supplement.
...
% Review between-group effects (eTable 12)
