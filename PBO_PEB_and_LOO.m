...
%% non-remitters in the CBT + placebo group reported in the Kung et al., 
%% manuscript
...
% M_PBO_Remission.mat, on each of the DCM intrinsic {'A'} and modulatory 
...
clear
load('PBO_GCM.mat');
load('M_PBO_Remission.mat'); % This design matrix contains data on 
...
BMA_PBO = spm_dcm_peb_bmc(PEB);

spm_dcm_peb_review (BMA_PBO, DCM);
